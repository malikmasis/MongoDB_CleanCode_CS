...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            //senin girdiğin koşullara göre ara find(query);
            //var jsonQuery = "{ firstname : \"malik\" }";//sample json query as text;
            ...
            var toReturn = collection.AsQueryable();  //Find(query); // execute the query - it's linq, nothing is sent to the server yet.
